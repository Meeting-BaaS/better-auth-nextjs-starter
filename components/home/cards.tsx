            ...
            case "mcp-cards":
                return (
                    <Heading
                        ...
                        description={
                            <>
                                MCP servers let you connect Meeting BaaS to external tools and LLMs,
                                such as{" "}
                                ...
                                , using the{" "}
                                <span className="font-semibold">Model Context Protocol</span>. All
                                servers are open source, and most are available hosted within
                                Meeting BaaS.
                            </>
                        }
